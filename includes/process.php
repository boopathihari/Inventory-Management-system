...
?>
            <tr>
                ...
                <td>
                    <button type="button" did="<?php echo $row['cid']; ?>" class="btn btn-outline-success del_cat">Delete</button>
                    <button type="button" eid="<?php echo $row['cid']; ?>" class="btn btn-outline-danger edit_cat" data-toggle="modal" data-target="#form_update">Edit</button>
                </td>
            </tr>
		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-outline-primary">Active</a></td>
			        <td>
			        	<a href="#" did="<?php echo $row['bid']; ?>" class="btn btn-outline-success del_brand">Delete</a>
			        	<a href="#" eid="<?php echo $row['bid']; ?>" data-toggle="modal" data-target="#form_brand" class="btn btn-outline-danger edit_brand">Edit</a>
			        </td>
			      </tr>
			<?php
			$n++;
		...
		foreach ($rows as $row) {
			?>
				<tr>
			        ...
			        <td><a href="#" class="btn btn-outline-primary">Active</a></td>
			        <td>
			        	<a href="#" did="<?php echo $row['pid']; ?>" class="btn btn-outline-success del_product">Delete</a>
			        	<a href="#" eid="<?php echo $row['pid']; ?>" data-toggle="modal" data-target="#form_products" class="btn btn-outline-danger edit_product">Edit</a>
			        </td>
			      </tr>
			<?php
			$n++;
